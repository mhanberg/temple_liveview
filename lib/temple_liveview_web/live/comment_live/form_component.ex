defmodule TempleLiveviewWeb.CommentLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.simple_form
        ...
        phx-submit="save"
      >
        <.input field={@form[:votes_count]} type="number" label="Votes count" />
  ...
  def handle_event("validate", %{"comment" => comment_params}, socket) do
    changeset =
      ...
      |> Social.change_comment(comment_params)
  ...
  defp save_comment(socket, :edit, comment_params) do
    case Social.update_comment(socket.assigns.comment, comment_params) do
      {:ok, comment} ->
